...
#if defined(AIR32F0)
#       include <libopencm3/air32/f0/st_usbfs.h>
#elif defined(AIR32F1)
#       include <libopencm3/air32/f1/st_usbfs.h>
#elif defined(AIR32F3)
#       include <libopencm3/air32/f3/st_usbfs.h>
#elif defined(AIR32L0)
#       include <libopencm3/air32/l0/st_usbfs.h>
#elif defined(AIR32L1)
#       include <libopencm3/air32/l1/st_usbfs.h>
#elif defined(AIR32L4)
#       include <libopencm3/air32/l4/st_usbfs.h>
#elif defined(AIR32G4)
#       include <libopencm3/air32/g4/st_usbfs.h>
#else
